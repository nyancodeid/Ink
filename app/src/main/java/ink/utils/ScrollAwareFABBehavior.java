...
/**
 * Created by PC-Comp on 6/21/2016.
 */
public class ScrollAwareFABBehavior extends FloatingActionMenu.Behavior {
    ...
    @Override
    public void onNestedScroll(final CoordinatorLayout coordinatorLayout, final FloatingActionMenu child, final View target, final int dxConsumed, final int dyConsumed, final int dxUnconsumed, final int dyUnconsumed) {
