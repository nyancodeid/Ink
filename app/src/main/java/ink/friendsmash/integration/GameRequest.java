...
import ink.friendsmash.HomeActivity;
...
public class GameRequest implements FacebookCallback<GameRequestDialog.Result> {
        ...
        GraphAPICall deleteRequestRequest = GraphAPICall.deleteRequest(
                ...
                new GraphAPICallback() {
                    ...
                    public void handleResponse(GraphResponse response) {
                        Log.i(StartupApplication.TAG, "Consumed Request deleted");
                    }

                    @Override
                    public void handleError(FacebookRequestError error) {
                        Log.e(StartupApplication.TAG, "Deleting consumed Request failed: " + error.getErrorMessage());
                    }
                });
    ...
    public void onSuccess(GameRequestDialog.Result result) {
        Log.i(StartupApplication.TAG, "Game Request sent successfully, request id=" + result.getRequestId());
    }

    @Override
    public void onCancel() {
        Log.i(StartupApplication.TAG, "Sending Game Request has been cancelled");
    }
