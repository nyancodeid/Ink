...
public class Toaster {
    ...
    public static void shortToast(View view, Window window, @StringRes int text) {
        Toast toast = makeToast(StartupApplication.getInstance().getString(text), Toast.LENGTH_SHORT);
    ...
    public static void shortToast(@StringRes int text) {
        shortToast(StartupApplication.getInstance().getString(text));
    }
    ...
    public static void longToast(@StringRes int text) {
        longToast(StartupApplication.getInstance().getString(text));
    }
    ...
    private static Toast makeToast(String text, @ToastLength int length) {
        return Toast.makeText(StartupApplication.getInstance(), text, length);
    }
