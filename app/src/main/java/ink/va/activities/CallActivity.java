...
import ink.databases.QbUsersDbManager;
import ink.va.fragments.IncomeCallFragment;
import ink.va.interfaces.ConversationFragmentCallbackListener;
import ink.va.interfaces.IncomeCallFragmentCallbackListener;
import ink.va.utils.Consts;
import ink.va.utils.FragmentExecuotr;
import ink.va.utils.NetworkConnectionChecker;
import ink.va.utils.PermissionsChecker;
import ink.va.utils.RingtonePlayer;
import ink.va.utils.SettingsUtil;
import ink.va.utils.Toaster;
import ink.va.utils.UsersUtils;
import ink.va.utils.WebRtcSessionManager;

public class CallActivity extends BaseActivity implements QBRTCClientSessionCallbacks, QBRTCSessionConnectionCallbacks, QBRTCSignalingCallback, IncomeCallFragmentCallbackListener, ConversationFragmentCallbackListener, NetworkConnectionChecker.OnConnectivityChangedListener {
