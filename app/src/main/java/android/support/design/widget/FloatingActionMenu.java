...
public class FloatingActionMenu extends ViewGroup {
    ...
    public Rect mShadowPadding = new Rect();
    ...
    private void initMenuButtonAnimations(TypedArray attr) {
        int showResId = attr.getResourceId(R.styleable.FloatingActionMenu_menu_fab_show_animation, R.anim.slide_up);
        ...
        int hideResId = attr.getResourceId(R.styleable.FloatingActionMenu_menu_fab_hide_animation, R.anim.slide_down);
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<FloatingActionMenu> {
        ...
        public boolean layoutDependsOn(CoordinatorLayout parent,
                                       FloatingActionMenu child, View dependency) {
        ...
        private void updateFabTranslationForSnackbar(CoordinatorLayout parent,
                                                     final FloatingActionMenu fab, View snackbar) {
